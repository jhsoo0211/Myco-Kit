<!-- 이 문서는 비개발자도 볼 수 있게 작성된 MyCo-Kit 웹사이트 통합 설계·운영 문서입니다. -->

# 🍄 MyCo-Kit 웹사이트 설계·요구사항 정의서 & 운영 가이드

> **한 줄 요약**: MyCo-Kit 웹사이트가 **무엇으로 · 어떻게 만들어졌고 · 어디를 어떻게 고치는지**를,
> 개발을 모르는 팀원도 스크린샷을 보며 이해할 수 있도록 정리한 문서입니다.

📅 최종 수정일: 2026-06-28 · 🌐 배포 주소: **https://ornate-beignet-ae6be6.netlify.app/**

> 🖼️ **이 문서는 "스크린샷 포함" 버전입니다.** 스크린샷이 없는 **텍스트 전용 버전**은 → [`SITE_DOCUMENTATION_TEXT.md`](SITE_DOCUMENTATION_TEXT.md)
> (내용은 동일하며, 화면 이미지만 뺀 가벼운 버전입니다.)
...
> 각 페이지의 실제 화면과, 내용을 고칠 때 열어야 할 파일 위치를 함께 적었습니다.

### 🏠 Home — `/` · [`src/pages/Home.tsx`](../src/pages/Home.tsx)
풀스크린 히어로 → 브랜드 슬로건 → 핵심 가치 3가지 → 임팩트 수치 → 비전/펀딩 유도.

<img src="screenshots/home.jpg" width="760" alt="홈 페이지 전체" />

### 🌿 About·Story·Mission·Partnership
| 페이지 | 경로 / 파일 | 화면 |
| --- | --- | --- |
| 브랜드 스토리 | `/story` · `src/pages/Story.tsx` | <img src="screenshots/story.jpg" width="380" alt="스토리" /> |
| 미션 & 비전 | `/mission` · `src/pages/Mission.tsx` | <img src="screenshots/mission.jpg" width="380" alt="미션" /> |
| 파트너십 | `/partnership` · `src/pages/Partnership.tsx` | <img src="screenshots/partnership.jpg" width="380" alt="파트너십" /> |
| About 개요 | `/about` · `src/pages/About.tsx` | <img src="screenshots/about.jpg" width="380" alt="About" /> |

### 🧪 Product — Kit / Technology / Impact / Cases
**Kit (`/kit`)** — 구성품 6종 + 활용 사례 카드. (구성품 수정: `src/pages/Kit.tsx`의 카드 배열)

<img src="screenshots/kit.jpg" width="760" alt="키트 구성품" />

| 페이지 | 경로 / 파일 | 화면 |
| --- | --- | --- |
| 핵심 원리 | `/technology` · `src/pages/Technology.tsx` | <img src="screenshots/technology.jpg" width="380" alt="핵심 원리" /> |
| 환경 임팩트 | `/impact` · `src/pages/Impact.tsx` | <img src="screenshots/impact.jpg" width="380" alt="임팩트" /> |
| 활용 사례 | `/cases` · `src/pages/CaseStudy.tsx` | <img src="screenshots/cases.jpg" width="380" alt="활용 사례" /> |

### 🌱 Experience — 체험 프로그램 / CAD
| 페이지 | 경로 / 파일 | 화면 |
| --- | --- | --- |
| 체험 프로그램 | `/experience` · `src/pages/Experience.tsx` | <img src="screenshots/experience.jpg" width="380" alt="체험 프로그램" /> |
| CAD 설계도 | `/cad` · `src/pages/CAD.tsx` | <img src="screenshots/cad.jpg" width="380" alt="CAD" /> |

### 🚀 Funding — 펀딩 / 직접 후원
| 페이지 | 경로 / 파일 | 화면 |
| --- | --- | --- |
| 와디즈 펀딩 | `/funding` · `src/pages/Funding.tsx` | <img src="screenshots/funding.jpg" width="380" alt="펀딩" /> |
| 직접 후원 | `/donation` · `src/pages/Donation.tsx` | <img src="screenshots/donation.jpg" width="380" alt="직접 후원" /> |

### ✉️ Contact — `/contact` · [`src/pages/Contact.tsx`](../src/pages/Contact.tsx)
문의 폼(이름/이메일/내용) + 이메일 안내.

<img src="screenshots/contact.jpg" width="760" alt="문의하기" />
...
<img src="screenshots/m-home.jpg" width="240" alt="모바일 홈" />
<img src="screenshots/m-menu.jpg" width="240" alt="모바일 메뉴" />
<img src="screenshots/m-kit.jpg" width="240" alt="모바일 키트" />
<img src="screenshots/m-funding.jpg" width="240" alt="모바일 펀딩" />
...
**Q. 스크린샷은 어디서 관리하나요?**
A. `docs/screenshots/` 폴더에 있습니다. 화면이 바뀌면 이미지를 새로 교체해 주세요.
...
| 날짜 | 수정 내용 | 담당자 | 비고 |
| --- | --- | --- | --- |
| 2026-06-28 | 문서 전면 개편: 실제 사이트 기준 재작성, 페이지별 스크린샷·요구사항·로드맵 추가 | — | 본 문서 |
